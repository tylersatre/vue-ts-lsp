...
- 8d02e22: Update Vue language server and JSON-RPC dependencies, refresh development and release tooling, and preserve plugin manifest formatting when synchronizing release versions.
- dbb6dde: Fix unified Vue and TypeScript navigation and lifecycle gaps:
