...
| tsserver-level debugging                                | Set the `VUE_TS_LSP_TSSERVER_LOG` environment variable (`terse`, `normal`, `requestTime`, or `verbose`) to make tsserver write its own log files. Off by default.        |
